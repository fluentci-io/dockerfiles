...
const image = new Dockerfile()
  ...
  .run("dagger version")
  .run("deno install -A -r -g --import-map https://raw.githubusercontent.com/fluentci-io/fluentci/main/import_map.json  https://raw.githubusercontent.com/fluentci-io/fluentci/main/main.ts -n fluentci")
